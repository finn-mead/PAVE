...
const AgePass = {
    ...
    /**
     * Store a receipt JWT in localStorage and shared storage for cross-origin access
    ...
    /**
     * Get stored receipt JWT from localStorage with cross-origin fallback
    ...
    /**
     * Clear stored receipt from localStorage and shared storage
     */
    async clearReceipt() {
